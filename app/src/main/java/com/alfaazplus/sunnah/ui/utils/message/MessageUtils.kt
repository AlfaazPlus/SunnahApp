...
object MessageUtils {
    ...
    fun showNoInternet(ctx: Context, cancelable: Boolean = true, runOnDismiss: (() -> Unit)? = null) {
        /*val builder = PeaceDialog2.newBuilder(ctx)
    ...
    fun showSomethingWrong(ctx: Context, runOnDismiss: (() -> Unit)? = null) {
        /*val builder = PeaceDialog2.newBuilder(ctx)
    ...
    fun show(context: Context, title: String, msg: String, btn: String, action: (() -> Unit)? = null) {
        /*val builder = PeaceDialog2.newBuilder(context)
